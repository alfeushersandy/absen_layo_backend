    ...
    <x-container>
        <div class="col-12">
            <x-card title="Tambah Karyawan" class="card-body">
                <form action="{{ route('admin.karyawans.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <x-input title="Section" name="section" type="text" placeholder="Masukkan Section"
                                value="{{ old('section') }}" />
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <x-input title="Jabatan" name="jabatan" type="text" placeholder="Masukkan Jabatan"
                                value="{{ old('jabatan') }}" />
                        </div>
                        <div class="col-6">
                            <x-select title="User Approve" name="user_approve">
                                ...
                                @foreach ($users as $user)
                                    <option value="{{ $user->nik }}" @selected(old('user_approve') == $user->id)>
